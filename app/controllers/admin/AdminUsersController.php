...
class AdminUsersController extends AdminController {
    ...
    public function getCreate()
    {
		...
		// Show the page
		return View::make('admin/users/create_edit', compact('roles', 'permissions', 'selectedRoles', 'selectedPermissions', 'title', 'mode', 'dashboards'));
    }
    ...
    public function getEdit($user)
    {
        if ( $user->id )
        {
        	...
        	return View::make('admin/users/create_edit', compact('user', 'roles', 'permissions', 'title', 'mode', 'dashboards'));
        }
        else
        {
