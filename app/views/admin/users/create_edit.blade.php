...
@section('content')
	<!-- Tabs -->
		<ul class="nav nav-tabs">
			...
			<li class=""><a href="#tab-dashboards" data-toggle="tab">Dashboards</a></li>
		</ul>
	<!-- ./ tabs -->
	...
	<form class="form-horizontal" method="post" action="@if (isset($user)){{ URL::to('admin/users/' . $user->id . '/edit') }}@endif" autocomplete="off">
		...
		<div class="tab-content">
			...
			<!-- Dashbaords tab -->
			<div class="tab-pane" id="tab-dashboards">
				<div class="form-group {{{ $errors->has('dashboards') ? 'error' : '' }}}">
				    <label class="col-md-2 control-label" for="dashboards">Active dashboards</label>
				    <div class="col-md-6">
				...
				<div class="form-group {{{ $errors->has('add_dashboards') ? 'error' : '' }}}">
				    <label class="col-md-2 control-label" for="add_dashboard">Add dashboard</label>
				    <div class="col-md-6">
				    </div>
				</div>
			</div>
